...
ax.text(point[0] + 2, point[1] + 8.5,r'$\mathrm{A}_{\min}$', fontsize=29, color='r', weight='bold')
ax.scatter(point2[0], point2[1], color='blue', s=50, marker='o')
ax.text(point2[0] - 20, point2[1] + 8.5,r'$\mathrm{B}_{\min}$', fontsize=29, color='blue', weight='bold')
ax.scatter(point3[0], point3[1], color='darkorange', s=50, marker='o')
ax.text(point3[0] - 16, point3[1] - 7.5,r'$\mathrm{C}_{\min}$', fontsize=29, color='darkorange', weight='bold')


fig.tight_layout()

plt.savefig('VU/text/Images/elip1minpoints.pdf')
# plt.show()
