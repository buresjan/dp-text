...
point = (79., 136.37)
point2 = (98.37, 131.34)
point3 = (113.16, 120.82)
point4 = (82, 130.93)
ax.scatter(point[0], point[1], color='r', s=50, marker='o')
ax.text(point[0] - 26, point[1] + 2.5,r'$\mathrm{A}_{\max}$', fontsize=29, color='r', weight='bold')
ax.scatter(point2[0], point2[1], color='blue', s=50, marker='o')
ax.text(point2[0] - 8, point2[1] + 6,r'$\mathrm{B}_{\max}$', fontsize=29, color='blue', weight='bold')
ax.scatter(point3[0], point3[1], color='darkorange', s=50, marker='o')
ax.text(point3[0] + 1, point3[1] + 3.5,r'$\mathrm{C}_{\max}$', fontsize=29, color='darkorange', weight='bold')
#ax.scatter(point4[0], point4[1], color='magenta', s=50, marker='o')
#ax.text(point4[0] - 5, point4[1] - 14.5,r'$\mathrm{D}_{\max}$', fontsize=29, color='magenta', weight='bold')

fig.tight_layout()

plt.savefig('VU/text/Images/elip2maxpoints.pdf')
# plt.show()
