...
\todo[inline]{Add typical choices of values for the NM parameters.}
\todo[inline]{Add diagram explaining the parallelization, accompany with runtime comparisons and brief explanation.}
